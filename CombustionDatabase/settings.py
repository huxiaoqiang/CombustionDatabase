...
DATABASES = {
    'default': {
        ...
        'NAME': 'combustiondb',                      # Or path to database file if using sqlite3.
        # The following settings are not used with sqlite3:
        'USER': 'root',
        'PASSWORD': 'ccedatabase212',
        'HOST': '101.6.240.45',                      # Empty for localhost through domain sockets or '127.0.0.1' for localhost through TCP.
...
SECRET_KEY = ')mm+q_*)maj_4s8ds!nhsk*^cfj+gc+-$yo!pf)_-xhrcq9(cg'
